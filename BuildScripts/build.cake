    ...
    .Does(() =>
{
    ...
    var publishDirectory = buildDirectory + Directory("app.publish");
    if(DirectoryExists(publishDirectory)) DeleteDirectory(publishDirectory, true);
    ...
    var chocolateyPackSettings   = new ChocolateyPackSettings {
                                     ...
                                     ProjectUrl              = new Uri("http://192.168.15.132:7990/projects/TOOL/repos/log2consolenew/browse"),
                                     PackageSourceUrl        = new Uri("http://192.168.15.132:7990/projects/TOOL/repos/log2consolenew/browse"),
                                     ProjectSourceUrl        = new Uri("http://192.168.15.132:7990/projects/TOOL/repos/log2consolenew/browse"),
                                     DocsUrl                 = new Uri("http://192.168.15.132:7990/projects/TOOL/repos/log2consolenew/browse"),

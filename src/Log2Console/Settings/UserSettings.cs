...
namespace Log2Console.Settings
{
    ...
    public sealed class UserSettings
    {
        ...
        [NonSerialized]
        private const string SettingsFileName = "Log2ConsoleSettings.dat";
        ...
        public static bool Load(string settingsFilePath=null)
        {
            bool ok = false;
        ...
        private static string GetSettingsFilePath()
        {
            ...
            var settingsFolder = Path.Combine(applicationFolder, "Settings");
